               ...
               <el-col :span="18">
                   ...
                   <el-col :span="12">
                       <el-form-item prop="bankCardTailPic">
                           <label class="centerDetail">银行卡反面面</label>
                           <el-upload
                               class="upload-demo"
                               drag
                   ...
                   <el-col :span="24">
                       ...
                       <el-col :span="8">
                           <el-form-item prop="bankCardNumbers" label="银行地址：">
                               <el-input v-model="bankDetailData.bankAddress"></el-input>
                           </el-form-item>
                       </el-col>
                       <el-col :span="8">
                   ...
                   <el-col :span="24">
                       <el-col :span="8">
                           <el-form-item prop="bankReason" label="审核备注">
                               <el-input v-model="bankDetailData.bankReason" type="textarea" :rows="2"
